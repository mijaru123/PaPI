...
class HelloStatusbarP(IPlugin):
    ...
    def __init__(self):
        ...
        # overriding them.
        super(HelloStatusbarP, self).__init__()
    ...
    def activate(self):
        ...
        super(HelloStatusbarP, self).activate()
        ...
        statusbar.push(statusbar.get_context_id("hello"), "Hello World PROCESS!")
        statusbar.show()
        self.app.window.get_child().pack_start(statusbar, False, True, 0)
        self.statusbar = statusbar
        #p1 = Process(target=self._pro, args=(statusbar))
        #p1.start()
        #self.p = p1
    ...
    def deactivate(self):
        ...
        super(HelloStatusbarP, self).deactivate()
    ...
    def _pro(self,stbar):
        stbar.push(statusbar.get_context_id("hello"), "Hello World PROCESS11!")
       # print("h")
