...
#
# Created: Wed Jun 25 16:23:26 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.showLicense, 3, 0, 1, 1)
        self.delPlot = QtGui.QPushButton(self.gridLayoutWidget)
        self.delPlot.setObjectName("delPlot")
        self.gridLayout.addWidget(self.delPlot, 0, 0, 1, 1)
        self.addPlot = QtGui.QPushButton(self.gridLayoutWidget)
        self.addPlot.setObjectName("addPlot")
        self.gridLayout.addWidget(self.addPlot, 1, 0, 1, 1)
        self.quitButton = QtGui.QPushButton(self.gridLayoutWidget)
        self.quitButton.setObjectName("quitButton")
        self.gridLayout.addWidget(self.quitButton, 4, 0, 1, 1)
        self.verticalLayoutWidget = QtGui.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 270, 751, 541))
